    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center p-4">
        <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="max-w-md bg-gray-800/90 backdrop-blur-xl border border-gray-700 rounded-2xl p-8 text-center shadow-2xl">
          ...
          <p className="text-gray-300 mb-6">The western content you're looking for doesn't exist or has been removed.</p>
          <Link to="/western" className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white rounded-xl font-semibold transition-all duration-300">
            <ArrowLeft className="w-4 h-4" />
            Back to western content
          </Link>
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 overflow-x-clip">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-64 h-64 sm:w-96 sm:h-96 bg-orange-500/10 rounded-full blur-3xl animate-pulse" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Content Card */}
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="bg-gray-800/90 backdrop-blur-xl border border-orange-500/30 rounded-2xl overflow-hidden shadow-2xl shadow-orange-500/10">
          {/* Header */}
          <div className="bg-gradient-to-r from-orange-900/40 to-orange-800/40 px-6 py-6 border-b border-orange-500/20">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div className="flex items-center gap-2 px-2 sm:px-3 py-1 bg-orange-500/20 text-orange-300 rounded-full border border-orange-500/30 backdrop-blur-sm">
            ...
            <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="text-xl sm:text-3xl font-bold text-white mb-4 leading-tight break-words">
              {content.name}
            </motion.h1>
            ...
            <div className="flex flex-wrap items-center gap-2 sm:gap-4">
              <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.3 }} className="flex items-center gap-2 px-2 sm:px-3 py-1 sm:py-1.5 bg-gray-700/50 rounded-lg border border-gray-600/50 backdrop-blur-sm">
                ...
                <span className="text-gray-300 text-xs sm:text-sm">{formatDate(content.postDate)}</span>
              </motion.div>

              <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.4 }} className="flex items-center gap-2 px-2 sm:px-3 py-1 sm:py-1.5 bg-orange-500/20 text-orange-300 rounded-lg border border-orange-500/30 backdrop-blur-sm">
          ...
          <div className="p-6">
            ...
            {/* VIP Upgrade Section */}
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.7 }} className="mt-6 bg-gradient-to-r from-yellow-500/10 to-yellow-600/10 border border-yellow-500/30 rounded-xl p-4 w-full max-w-full">
