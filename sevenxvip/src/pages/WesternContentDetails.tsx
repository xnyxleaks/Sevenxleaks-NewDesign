          ...
          <div className="bg-gradient-to-r from-orange-900/40 to-orange-800/40 px-6 py-6 border-b border-orange-500/20">
            ...
            <div className="flex flex-wrap items-center gap-2 sm:gap-4">
              ...
              <motion.div
                ...
                className="flex items-center gap-2 px-2 sm:px-3 py-1 sm:py-1.5 bg-orange-500/20 text-orange-300 rounded-lg border border-orange-500/30 backdrop-blur-sm"
              >
