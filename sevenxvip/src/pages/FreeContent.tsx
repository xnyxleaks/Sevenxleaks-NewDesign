...
function Freecontent() {
  ...
  const contentType = localStorage.getItem('contentType') || 'asian';
  ...
  const handleBecomeVIP = () => navigate("/plans");
  ...
  return (
    <div className={`min-h-screen ${
      contentType === 'western' ? 'western-theme' : ''
    }`} style={{ 
          ...
          >
            ...
            >
              ...
              <div className="text-center">
                <div className="mb-6">
                  <i
                    className="fa-solid fa-crown text-4xl"
                    style={{ color: "var(--accent-vip)" }}
                  ></i>
                </div>

                <h2 className="modal-title">Unlock Premium Experience</h2>
                <p
                  className="mb-6 text-sm"
                  style={{ color: "var(--text-secondary)" }}
                >
                  Upgrade to VIP for an ad-free experience and exclusive
                  content.
                </p>
